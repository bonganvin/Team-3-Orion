...
namespace OVS_Team_3_API.Controllers.Employee_Subsystem
{
    ...
    public class EmployeeController : ApiController
    {
        ...
        public ResponseObject UpdateEmployee([FromBody] EmployeeVM employee)
        {
            ...
            try
            {
                toUpdate.Employee_ID = employee.EmployeeID;
                toUpdate.Employee_Name = employee.EmployeName;
                ...
                toUpdate.Employee_Type = employee.EmployeeType; 
                toUpdate.User = employee.User;
                db.SaveChanges();
